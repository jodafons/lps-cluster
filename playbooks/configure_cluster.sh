...
ansible-playbook -i yaml/hosts yaml/host/add_storage.yaml -e "hostname=caloba-v02 storage_name=storage01 ip_address=10.1.1.202"
ansible-playbook -i yaml/hosts yaml/host/add_storage.yaml -e "hostname=caloba-v02 storage_name=storage02 ip_address=10.1.1.203"
ansible-playbook -i yaml/hosts yaml/host/add_storage.yaml -e "hostname=caloba-v08 storage_name=storage01 ip_address=10.1.1.202"
ansible-playbook -i yaml/hosts yaml/host/add_storage.yaml -e "hostname=caloba-v08 storage_name=storage02 ip_address=10.1.1.203"
ansible-playbook -i yaml/hosts yaml/host/add_storage.yaml -e "hostname=caloba-v13 storage_name=storage01 ip_address=10.1.1.202"
ansible-playbook -i yaml/hosts yaml/host/add_storage.yaml -e "hostname=caloba-v13 storage_name=storage02 ip_address=10.1.1.203"
